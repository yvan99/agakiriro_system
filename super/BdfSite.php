...
<body style="background-color: #fff !important;">
    ...
    <div class="container-fluid invoice-container" style="max-width: 970px !important;">
        ...
        <main>
            ...
            <?php  
                            $id = $_GET['id'];
                            $query = mysqli_query($conn, "SELECT * from worker, agakiriro WHERE worker.agakiriro_id  = aga_id and name = '$id' AND capital = 'BDF' ");
                        ?>

                <div class="col-sm-6 order-sm-0"> <strong>MINISTRY OF TRADE AND INDUSTRY </strong>
                    <address style="font-style: upperca;">
                        <?php echo $id; ?> SECTOR<br />
                        <?php echo date("y-m-d"); ?>
                    </address>
                </div>
            </div>
