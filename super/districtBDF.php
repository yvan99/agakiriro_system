                                        ...
                                        <div class="control-group">
                                            ...
                                            <select name='district' onchange="changeDistrict(this.form)">
                                                ...
                                                <?php
                                                        ...
                                                        echo "</select>";
                                                ?>
                                                <a href="BdfReport.php?id=<?php echo $cat ?>" class="btn btn-info border text-light-50 shadow-none"> Print Document</a>
											</div>
										</div>
                                </div>
                                <br>
                                <?php
                                $sql = "SELECT * from worker, agakiriro WHERE worker.agakiriro_id  = aga_id and location = '$cat' AND capital = 'BDF'";
