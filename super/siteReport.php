                            ...
                            <div class="module">
                                ...
                                <form class="form-horizontal row-fluid">
                                        <div class="control-group">
                                            ...
                                            ?>
                                            <select name='site' onchange="changeSite(this.form)">
                                                ...
                                                <?php
                                                        ...
                                                        echo "</select>";
                                                ?>
                                                <a href="reportSite.php?id=<?php echo $cat ?>" class="btn btn-info border text-light-50 shadow-none"> Print Document</a>
											</div>
										</div>
                                </div>
                                <br>
                                <?php
                                $sql = "SELECT * from worker, agakiriro WHERE worker.agakiriro_id  = aga_id and name = '$cat'";
